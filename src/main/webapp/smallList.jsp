                ...
                <li>
                    ...
                    <table id=table cellspacing=0 cellpadding=2 width=100% border=1>
                        ...
                        <c:forEach items="${listSmall}" var="small">
                            <tr>
                                <td>${small.sid }</td>
                                <td><a href="bigServlet?flag=byIdBig&id=${small.sid }&flag1=detil" id="a">${small.sname}</a></td>
                                <td>${small.bsid.bname}</td>
                                <td>${small.bsid.btype==0?"支出":"收入"}</td>
                                <td>
                                   <button><a href="delSmall?id=${small.sid}" onclick="return aaa()">删除</a></button>
                                    <button><a href="byIdSmall?sid=${small.sid}">修改</a></button>

                            </tr>
                        </c:forEach>
                    </table>
                        <tr>
                            <button><a href="smallListPage">首页</a></button>
                            <button><a href="smallListPage?page=${page-1}" onclick="return aa(${page-1})">上一页</a></button>
                            <button><a href="smallListPage?page=${page+1}" onclick="return cc(${page})">下一页</a></button>
                            <button><a href="smallListPage?page=${lastPage}">尾页</a></button>
                        </tr>
                    ...
                    <form action="smallListPage" method="post" onsubmit="return bb()">
